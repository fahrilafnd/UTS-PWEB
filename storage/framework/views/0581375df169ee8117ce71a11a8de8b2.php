    ...
    <div class="p-6 bg-white rounded">
      ...
      <h1 class="tracking-wide">META JAYA <span class="font-mono">™</span></h1>
        ...
        class="flex flex-col justify-center">
          ...
          focus:ring-1
          focus:ring-sky-500
          focus:invalid:border-red-500 focus:invalid:ring-red-500" type="text" name="username" placeholder="Username" required>
          ...
          focus:invalid:border-red-500 focus:invalid:ring-red-500" type="password" name="password" placeholder="********" required>
            ...
            <button class="px-4 py-1.5 rounded-md shadow-lg bg-sky-600 font-medium text-gray-100 block hover:bg-sky-700 transition duration-300" onclick="window.location.href = 'http://127.0.0.1:8000/dashboard/admin'">Login</button>
            <div class="flex justify-evenly mt-5">
                <a
                  href="#"
                  class="w-full text-center font-medium text-black"
                  >Recover password!</a
                >
                <a
...
</html><?php /**PATH C:\laragon\www\utspweb\resources\views/auth/login.blade.php ENDPATH**/ ?>